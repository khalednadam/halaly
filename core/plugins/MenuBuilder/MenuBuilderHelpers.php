...
class MenuBuilderHelpers
{
    ...
    public function render_dynamic_pages_list($dynamic_page_list,$lang): string
    {
        ...
        foreach ($dynamic_page_list as $key => $page_details){
            ...
            $output .= '</ul>';
            $output .= '<div class="form__input__single">';
            $output .= '<button type="button"  class="cmnBtn btn_5 btn_bg_blue radius-5 mt-4 pr-4 pl-4 add_page_to_menu">'.__('Add To Menu').'</button>';
