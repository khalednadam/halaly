...
class Image extends PageBuilderField
{
    ...
    public function render()
    {
        ...
        $output .= ' <button type="button" class="cmnBtn btn_5 btn_bg_secondary radius-5 media_upload_form_btn" data-btntitle="'.__('Select Image').'" data-modaltitle="'.__('Upload Image').'" data-imgid="'.$this->value().'" data-bs-toggle="modal" data-bs-target="#media_upload_modal">'.$image_upload_btn_label.'</button>';
        $output .= '</div>';
