...
abstract class WidgetBase
{
    ...
    {
        $widget_data = !empty($this->args['id']) ? Widget::find($this->args['id']) : [];

        $widget_data = !empty($widget_data) ? WidgetBuilderSetup::format_widget_content($widget_data?->widget_content,['class' => false]) : "";
    ...
    */
    ...
    public function admin_form_submit_button($text = null){
        ...
        return '<button class="cmnBtn btn_5 btn_bg_blue radius-5 widget_save_change_button">' . $button_text . '</button>';
    }
