                                    ...
                                    <form id="submit_client_verify_info" enctype="multipart/form-data">
                                        ...
                                        <div class="identity-verifying">
                                            ...
                                            <div class="identity-verifying-form custom-form profile-border-top">
                                                ...
                                                <x-form.country-dropdown :title="__('ID issuing country')" :name="'country'" :id="'country'" :required="false"/>
                                                <div class="single-flex-input">
                                                    <x-form.state-dropdown :title="__('State')" :name="'state'" :id="'state'" :required="false"/>
                                                    <x-form.city-dropdown :title="__('City')" :name="'city'" :id="'city'" :required="false"/>
                                                </div>
