    ...
    <div class="user-profile section-padding2">
        <div class="container-1920 plr1">
            <div class="container-1492 user-profile-wraper  mx-auto">
                <x-breadcrumb.user-profile-breadcrumb :title="''" :innerTitle="__('User Profile')" :subInnerTitle="''"
                                ...
                                <div class="seller-details">
                                    <div class="seller-details-wraper">
                                        ...
                                        <div class="seller-name">
                                            ...
                                            <div class="member-listing">
                                                <span class="listing">{{ $user->listings->count() ?? 0 }}
                                                    {{ __('listing') }} </span>
                                                <span class="dot">&middot;</span> {{ __('Member since') }}
                                    ...
                                    <div class="seller-ratings">
                                        ...
                                        <div class="rating-btn">
                                            <a href="javascript:void(0)" class="review_add_modal" data-bs-toggle="modal"
                                        ...
                                        @if($user->role == 'vendor')
                                            ...
                                            @elseif(!auth()->check())
                                                <div class="rating-btn">
                                                    <a href="{{ route('user.login', ['return' => 'profile/' . $user->username, 'follow_user_id' => $user->id]) }}">
                                                        <span>{{ __('Follow') }}</span>
                                                    </a>
                                                </div>
                                            @endif
                                ...
                                <div class="seller-contact">
                                    ...
                                    <div class="emails">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0.5 2.83335C0.5 2.39133 0.675595 1.9674 0.988155 1.65484C1.30072 1.34228 1.72464 1.16669 2.16667 1.16669H13.8333C14.2754 1.16669 14.6993 1.34228 15.0118 1.65484C15.3244 1.9674 15.5 2.39133 15.5 2.83335M0.5 2.83335V11.1667C0.5 11.6087 0.675595 12.0326 0.988155 12.3452C1.30072 12.6578 1.72464 12.8334 2.16667 12.8334H13.8333C14.2754 12.8334 14.6993 12.6578 15.0118 12.3452C15.3244 12.0326 15.5 11.6087 15.5 11.1667V2.83335M0.5 2.83335L8 7.83335L15.5 2.83335"
                                                stroke="#1E293B" stroke-linecap="round" stroke-linejoin="round" />
