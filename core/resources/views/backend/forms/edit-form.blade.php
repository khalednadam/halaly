    ...
    <div class="row g-4 mt-0">
        <div class="col-xl-8 col-lg-8">
            <div class="dashboard__card bg__white padding-20 radius-10">
                ...
                <a href="{{route('admin.form')}}" class="cmnBtn btn_5 btn_bg_blue radius-5 mt-4 mt-3">{{__('All Form')}}</a>
                  <x-validation.error/>
                    <form action="{{route('admin.form.update')}}" method="Post">
                        ...
                        <div class="single-input mt-3 mb-3">
                        ...
                        <button type="submit" class="cmnBtn btn_5 btn_bg_blue radius-5 mt-4">{{__('Save Change')}}</button>
                    </form>
                </div>
            </div>
            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        ...
                        <h4 class="header-title mb-3">{{__("Available Form Fields")}}</h4>
