            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-4">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="{{route('admin.guest.all.listings')}}">{{__('All Guest Listings')}}</a>
                    </div>
                </div>
                <x-validation.error/>
                    <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="d-flex flex-wrap justify-content-between gap-3 mt-4">
                                                            ...
                                                            <div class="form__input__single mt-4">
                                                                <x-meta.admin-edit-listing-meta-section :listing="$listing"/>
                                                            </div>    
