                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('All Guest Listings') }}</h4>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            @include('backend.pages.listings.guest-listings.search-listing')
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    @can('guest-listing-bulk-delete')
    <x-bulk-action.bulk-action-js :url="route('admin.guest.listing.bulk.action')"/>
    @endcan
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                $(document).on('keyup','.notice_string_search',function(){
                    ...
                    $.ajax({
                        url:"{{ route('admin.guest.listings.search') }}",
                        method:'GET',
                ...
                function notices(page){
                    $.ajax({
                        url:"{{ route('admin.guest.listings.paginate').'?page='}}" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
