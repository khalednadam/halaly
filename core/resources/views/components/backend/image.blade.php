...
<div class="single-input mb-3 {{$class}}">
    ...
    <div class="media-upload-btn-wrapper">
        ...
        <button type="button" class="cmnBtn btn_5 btn_bg_secondary radius-5 media_upload_form_btn" data-btntitle="{{__('Select Image')}}" data-modaltitle="{{__('Upload Image')}}" data-imgid="{{$id ?? ''}}" data-bs-toggle="modal" data-bs-target="#media_upload_modal">
