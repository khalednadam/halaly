                    ...
                    <div class="plugin-grid">
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color google_adsense">
                                <strong class="google_adsense">{{__("Google Adsense")}}</strong>
                            </div>
                            <p class="plugin-meta">
                                {{__("you can configure Google Adsense into the website. It will work if any Google Adsense feature is available")}}
                            </p>
                            <div class="btn-group-wrap">
                                <a href="#" data-option="google_adsense_status" data-status="{{$method("google_adsense_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("google_adsense_status") == 'on' ? __("Deactivate") : __("Active") }}</a>
