                                ...
                                <form action="{{route('admin.city.import.database')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            @php $countries = \Modules\CountryManage\app\Models\Country::all_countries(); @endphp
                                            <td>
                                                <div class="form-group">
                                                    <select class="form__control radius-5 select2_activation" name="country_id" id="country_id">
                                        ...
                                        <tr>
                                            ...
                                            @php $cities = \Modules\CountryManage\app\Models\State::all_states(); @endphp
                                            <td>
                                                <div class="form-group">
                                                    <select name="state_id" id="state_id" class="get_country_state form__control radius-5 select2_activation">
