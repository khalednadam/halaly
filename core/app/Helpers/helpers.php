...
function render_page_meta_data($blog_post){
    ...
    $meta_title = !empty( $blog_post?->meta_data?->meta_title) ?  $blog_post?->meta_data?->meta_title :$blog_post->title;
    $site_tags = $blog_post?->meta_data?->meta_tags;
    $site_description =  $blog_post?->meta_data?->meta_description;
    
    $facebook_meta_tags = !empty( $blog_post?->meta_data?->facebook_meta_tags) ?  $blog_post?->meta_data?->facebook_meta_tags : $meta_title;
    $facebook_meta_description =  $blog_post?->meta_data?->facebook_meta_description;
    $facebook_meta_image =  get_attachment_image_by_id($blog_post?->meta_data?->facebook_meta_image ?? $blog_post->image)['img_url'] ?? "";
    $facebook_meta_image_alt =  get_attachment_image_by_id($blog_post?->metaData?->facebook_meta_image ?? $blog_post->image)['img_alt'] ?? '';
    
    $twitter_meta_tags =!empty( $blog_post?->meta_data?->twitter_meta_tags) ? $blog_post?->meta_data?->twitter_meta_tags : $meta_title;
    $twitter_meta_description =  $blog_post?->meta_data?->twitter_meta_description;
    $twitter_meta_image =  get_attachment_image_by_id($blog_post?->meta_data?->twitter_meta_image ?? $blog_post->image)['img_url'] ?? "";
...
function render_page_meta_data_for_listing($listing_details){
    ...
    $meta_title =  !empty($listing_details->metaData->meta_title) ? $listing_details->metaData->meta_title : $listing_details->title;
    $site_tags = $listing_details->metaData->meta_tags ?? '';
    $site_description =  $listing_details->metaData->meta_description ?? '';
    $facebook_meta_tags =!empty($listing_details->metaData->facebook_meta_tags) ? $listing_details->metaData->facebook_meta_tags : $meta_title;

    $facebook_meta_description =  $listing_details->metaData->facebook_meta_description ?? '';
    $facebook_meta_image =  get_attachment_image_by_id($listing_details->metaData->facebook_meta_image ?? $listing_details->image)['img_url'] ?? '';
    $facebook_meta_image_alt =  get_attachment_image_by_id($listing_details->metaData->facebook_meta_image ?? $listing_details->image)['img_alt'] ?? '';

    $twitter_meta_tags =!empty($listing_details->metaData->twitter_meta_tags) ? $listing_details->metaData->twitter_meta_tags : $meta_title;

    $twitter_meta_description =  $listing_details->metaData->twitter_meta_description ?? '';
    $twitter_meta_image =  get_attachment_image_by_id($listing_details->metaData->twitter_meta_image ?? $listing_details->image)['img_url'] ?? '';
...
function render_page_meta_data_for_category($category){
    ...
    $meta_title = !empty( $category->metaData->meta_title) ?$category->metaData->meta_title :$title;
    $site_tags = $category->metaData->meta_tags ?? '';
    $site_description =  $category->metaData->meta_description ?? '';
    
    $facebook_meta_tags =!empty( $category->metaData->facebook_meta_tags) ? $category->metaData->facebook_meta_tags : $meta_title;
    $facebook_meta_description =  $category->metaData->facebook_meta_description ?? '';
    $facebook_meta_image =  get_attachment_image_by_id($category->metaData->facebook_meta_image ?? $category->image)['img_url'] ?? '';
    $facebook_meta_image_alt =  get_attachment_image_by_id($category->metaData->facebook_meta_image ?? $category->name)['img_alt'] ?? '';
    
    $twitter_meta_tags =!empty( $category->metaData->twitter_meta_tags) ? $category->metaData->twitter_meta_tags : $meta_title;
    $twitter_meta_description =  $category->metaData->twitter_meta_description ?? '';
    $twitter_meta_image =  get_attachment_image_by_id($category->metaData->twitter_meta_image ?? $category->name)['img_url'] ?? '';
...
function render_page_meta_data_for_subcategory($subcategory){
    ...
    $meta_title = !empty( $subcategory->metaData->meta_title ) ? $subcategory->metaData->meta_title  :$title;
    $site_tags = $subcategory->metaData->meta_tags ?? '';
    $site_description =  $subcategory->metaData->meta_description ?? '';
   
    $facebook_meta_tags =  !empty( $subcategory->metaData->facebook_meta_tags ) ? $subcategory->metaData->facebook_meta_tags : $meta_title;
    $facebook_meta_description =  $subcategory->metaData->facebook_meta_description ?? '';
    $facebook_meta_image =  get_attachment_image_by_id($subcategory->metaData->facebook_meta_image ?? $subcategory->image)['img_url'] ?? '';
    $facebook_meta_image_alt =  get_attachment_image_by_id($subcategory->metaData->facebook_meta_image ?? $subcategory->image)['img_alt'] ?? '';
    
    $twitter_meta_tags =!empty($subcategory->metaData->twitter_meta_tags ) ? $subcategory->metaData->twitter_meta_tags : $meta_title;
    $twitter_meta_description =  $subcategory->metaData->twitter_meta_description ?? '';
    $twitter_meta_image =  get_attachment_image_by_id($subcategory->metaData->twitter_meta_image ?? $subcategory->image)['img_url'] ?? '';
...
function render_page_meta_data_for_child_category($child_category){
    ...
    $meta_title = !empty($child_category->metaData->meta_title  ) ? $child_category->metaData->meta_title  :$title;
    $site_tags = $child_category->metaData->meta_tags ?? '';
    $site_description =  $child_category->metaData->meta_description ?? '';
   
    $facebook_meta_tags =  !empty($child_category->metaData->facebook_meta_tags) ? $child_category->metaData->facebook_meta_tags : $meta_title;
    $facebook_meta_description =  $child_category->metaData->facebook_meta_description ?? '';
    $facebook_meta_image =  get_attachment_image_by_id($child_category->metaData->facebook_meta_image ?? $child_category->image)['img_url'] ?? '';
    $facebook_meta_image_alt =  get_attachment_image_by_id($child_category->metaData->facebook_meta_image ?? $child_category->image)['img_alt'] ?? '';
    
    $twitter_meta_tags = !empty($child_category->metaData->twitter_meta_tags) ?$child_category->metaData->twitter_meta_tags : $meta_title;
    $twitter_meta_description =  $child_category->metaData->twitter_meta_description ?? '';
    $twitter_meta_image =  get_attachment_image_by_id($child_category->metaData->twitter_meta_image ?? $child_category->image)['img_url'] ?? '';
