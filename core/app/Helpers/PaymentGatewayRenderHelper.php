        ...
        if ($has_manual_payment_gateway) {
            $output .= '<div class="manual_payment_gateway_extra_field">
                            <div class="form-group single-input d-none manual_transaction_id mt-4">
                                ...
                                <input type="file" name="trasaction_attachment"  class="form-control form--control mt-2 icofont-line-height"  style="line-height: 2.5rem"  placeholder="'.__('Transaction Attachment').'" accept="image/*">
                           </div>
                         </div>';
        }
