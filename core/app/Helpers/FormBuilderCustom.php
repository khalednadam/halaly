...
<div class="btn-wrapper send-massage mt-3">
    <button id="contact_form_btn" type="submit" class="red-btn custom_submit_form_button {$button_class}">{$text}</button>
    {$preloader}
</div>
HTML;
    ...
    private static  function get_field_by_type($type, $name, $placeholder, $options = [], $requried = null, $mimes = null)
    {
        ...
        switch ($type) {
            case('email'):
                ...
                $markup = ' <div class="input-form input-form2"> <label for="' . $name . '" class="' . $label_class . '">' . __($placeholder) . '</label> <input type="email" id="' . $name . '" name="' . $name . '" class="form-control input-field" placeholder="' . __($placeholder) . '" ' . $required_markup . '></div>';
                break;
            case('tel'):
                $required_markup = !empty($requried) ? $required_markup_html : '';
            ...
            case('textarea'):
                $required_markup = !empty($requried) ? $required_markup_html : '';
                $markup = ' <div class="input-form textarea"><label for="' . $name . '" class="' . $label_class . '">' . __($placeholder) . '</label> <textarea name="' . $name . '" id="' . $name . '" cols="30" rows="5" class="form-control" placeholder="' . __($placeholder) . '" ' . $required_markup . '></textarea></div>';
                break;
            case('file'):
                $required_markup = !empty($requried) ? $required_markup_html : '';
            ...
            default:
                $required_markup = !empty($requried) ? $required_markup_html : '';
                $markup = ' <div class="input-form input-form2"><label for="' . $name . '" class="' . $label_class . '">' . __($placeholder) . '</label> <input type="text" id="' . $name . '" name="' . $name . '" class="form-control input-field" placeholder="' . __($placeholder) . '" ' . $required_markup . '></div>';
                break;
        }
